...
namespace DAL
{
    public class Modbus
    {
        ...
        /// <returns></returns>
        private bool OpenMyCom(int iBaudRate, string iPortNo, int iDataBits, Parity iParity, StopBits iStopBits)
        {
            try
            {
                if (MyCom.IsOpen)
                ...
                MyCom.DataReceived += MyCom_DataRecieved;
        ...
        private void MyCom_DataRecieved(object sender, SerialDataReceivedEventArgs e)
        {
        ...
        public byte[] ReadKeepReg(int iDevAdd, int iAddress, int iLength)
        {
            ...
            Crc16(SendCommand, 6);
            SendCommand[6]=ucCRCHi;
            SendCommand[7]=ucCRCLo;
